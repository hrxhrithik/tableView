...
#ifndef SINGLEVIEW_SWIFT_H
#define SINGLEVIEW_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SingleView",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC10SingleView11AppDelegate")
...
SWIFT_CLASS("_TtC10SingleView13SceneDelegate")
...
SWIFT_CLASS("_TtC10SingleView14ViewController")
...
@interface ViewController (SWIFT_EXTENSION(SingleView)) <UITableViewDelegate>
...
@interface ViewController (SWIFT_EXTENSION(SingleView)) <UITableViewDataSource>
